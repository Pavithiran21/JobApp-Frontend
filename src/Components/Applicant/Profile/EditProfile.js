...
export const EditProfile = () => {
        ...
        const SubmitHandler = (data) => {
                axios.put(`${API}/api/profiles/edit-profile/${id}`,data, {
                        headers: {
                        authorization:window.localStorage.getItem('token'),
                        },
                })
        ...
        return (
                ...
                <>
                        ...
                        <Row>
                        <Col>
                        <h1 className="text-center text-primary  m-1">Edit Profile</h1>
                        </Col>
                        </Row>
                                ...
                                <Row>
                                        <Col>
                                                {Edit &&(
                                                        ...
                                                        martialStatus:Edit?.data?.martialStatus,
                                                        dob:Edit?.data?.dob,
                                                        address:Edit?.data?.address,
                                                        pincode:Edit?.data?.pincode,
                                                        sslc:Edit?.data?.sslc,
                                                        hsc:Edit?.data?.hsc,
                                                        sslcboard:Edit?.data?.sslcboard,
                                                        sslcPercent:Edit?.data?.sslcPercent,
                                                        sslcPassedout:Edit?.data?.sslcPassedout,
                                                        hscboard:Edit?.data?.hscboard,
                                                        hscPercent:Edit?.data?.hscPercent,
                                                        hscPassedout:Edit?.data?.hscPassedout,
                                                        qualification:Edit?.data?.qualification,
                                                        graduation:Edit?.data?.graduation,
                                                        coursetype:Edit?.data?.coursetype,
                                                        university:Edit?.data?.university,
                                                        specialization:Edit?.data?.specialization,
                                                        percentage:Edit?.data?.percentage,
                                                        collegepassedout:Edit?.data?.collegepassedout,
                                                        skill:Edit?.data?.skill,
                                                        languages:Edit?.data?.languages,
                                                        projectname:Edit?.data?.projectname,
                                                        projectdescription:Edit?.data?.projectdescription,
                                                        linkedinProfile:Edit?.data?.linkedinProfile,
                                                        experience:Edit?.data?.experience,
                                                        companyname:Edit?.data?.companyname,
                                                        yearofexperience:Edit?.data?.yearofexperience,
                                                        designation:Edit?.data?.designation
                                                        }}
                                                        ...
                                                        <Row>
                                                                ...
                                                                <Row className='text-center'>
                                                                        <Col>
                                                                                ...
                                                                                <Button variant='outline-success' className='m-2' type='submit'>Edit</Button>
