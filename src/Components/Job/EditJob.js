...
export const EditJob = () => {
  ...
  const SubmitHandler = async (data) => {
    ...
    try {
      ...
      const response = await axios.put(`${API}/api/jobs/admin/edit-job/${id}`, data,{
        headers: {
          authorization:window.localStorage.getItem('token'),
        },
      });
  ...
  return (
    <>
      ...
      <Container fluid className='dashboard'>
        <Row>
          <Col>
            <h1 className="text-center m-3">Update A Job</h1>
          </Col>
        </Row>
        <Row>
                          ...
                          <Col>
                              <div className="form-group">
                                ...
                                >
                                  ...
                                  <option value="4years&above">4 years and above</option>
                        ...
                        <Row className='text-center'>
                          <Col>
                            <div className='text-center'>
                              <Button variant='outline-primary' className='m-2' type='submit'>Update</Button>
